...
def send_email_with_multiple_attachments(get_subject,get_body,get_attaching_folder_path):
    email_user = sender_email
    email_password = sender_email_pwd
    email_send = recepient_email
    file_list = os.listdir(get_attaching_folder_path)
    print(file_list)
    ...
    for file in file_list:
        #filepath = get_attaching_folder_path+"\\"+file
        filepath = os.path.join(get_attaching_folder_path,file)
